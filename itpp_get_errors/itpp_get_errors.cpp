...
* 
* <outputErrorCount> = itpp_get_errors(<binaryInputBitStream1>,<inputBitStream2>)
*
...
*----------------------
* It is expected that the user inputs two binary arrays of (0,1) in scilab engine while calling the itpp_get_errors() 
...
int itpp_get_errors(char *fname, unsigned long fname_len)
{
