...
* 
* <outputPulseShape> = rrc_get_pulse_shape(double roll_off_factor, int filter_length, int upsampling_factor)
*
...
*-----------------------------------
* The function rrc_get_pulse_shape() gives the shape of the pulse which will be further used in upsampling and shaping of the input signal. It 
...
* rrc_get_pulse_shape() function and expect the function to return pulse shape vector as output in scilab console.
*/
...
int itpp_rrc_get_pulse_shape(char *fname, unsigned long fname_len)
{
