...
* 
* <outputBitStream> = hamm_decode(<InputBitStream>,<integer m>)
*
...
* hamm_decode() function and expect the function to return a single dimension binary matrix of (0,1) as decoded output in scilab
* console.
*/
